...
namespace HouseRentingSystem.Data
{
    ...
    {
        private IdentityUser AgentUser { get; set; } = new IdentityUser();
        
        private IdentityUser GuestUser { get; set; } = new IdentityUser();

        private Agent Agent { get; set; } = new Agent();

        private Category CottageCategory { get; set; } = new Category();

        private Category SingleCategory { get; set; } = new Category();

        private Category DuplexCategory { get; set; } = new Category();

        private House FirstHouse { get; set; } = new House();

        private House SecondHouse { get; set; } = new House();
        
        private House ThirdHouse { get; set; } = new House();
